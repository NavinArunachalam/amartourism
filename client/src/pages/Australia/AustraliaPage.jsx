  ...
  return (
    <div className="common-styles">
      ...
      <section>
        ...
        <div className="day">
          <img src="https://images.unsplash.com/photo-1545044846-351ba102b6d5?auto=format&fit=crop&w=800&q=80" alt="Melbourne" />
        ...
        <div className="day">
          ...
          <img src="https://images.unsplash.com/photo-1578662996448-3a300e7c7d8a?auto=format&fit=crop&w=800&q=80" alt="Phillip Island Penguins" />
        </div>
        <div className="day">
          <img src="https://images.unsplash.com/photo-1545044846-351ba102b6d5?auto=format&fit=crop&w=800&q=80" alt="Great Ocean Road" />
          <div className="day-content">
        ...
        <div className="day">
          ...
          <img src="https://images.unsplash.com/photo-1578662996448-3a300e7c7d8a?auto=format&fit=crop&w=800&q=80" alt="Canberra" />
        </div>
        <div className="day">
          <img src="https://images.unsplash.com/photo-1545044846-351ba102b6d5?auto=format&fit=crop&w=800&q=80" alt="Parliament House" />
          <div className="day-content">
        ...
        <div className="day">
          ...
          <img src="https://images.unsplash.com/photo-1506905925340-14f5ada2c2d0?auto=format&fit=crop&w=800&q=80" alt="Sydney Opera House" />
        </div>
        <div className="day">
          <img src="https://images.unsplash.com/photo-1578662996448-3a300e7c7d8a?auto=format&fit=crop&w=800&q=80" alt="Blue Mountains" />
          <div className="day-content">
        ...
        <div className="day">
          ...
          <img src="https://images.unsplash.com/photo-1545044846-351ba102b6d5?auto=format&fit=crop&w=800&q=80" alt="Departure" />
        </div>
      </section>
      <section>
