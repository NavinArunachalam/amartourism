  ...
  return (
   <div className="common-styles">
      ...
      <section>
        ...
        <div className="day">
          <img src="https://images.unsplash.com/photo-1586023492125-27a3d7ed11b6?auto=format&fit=crop&w=800&q=80" alt="Oslo" />
        ...
        <div className="day">
          ...
          <img src="https://images.unsplash.com/photo-1578662996448-3a300e7c7d8a?auto=format&fit=crop&w=800&q=80" alt="Oslo Fjord" />
        </div>
        <div className="day">
          <img src="https://images.unsplash.com/photo-1506905925340-14f5ada2c2d0?auto=format&fit=crop&w=800&q=80" alt="Stockholm" />
          <div className="day-content">
        ...
        <div className="day">
          ...
          <img src="https://images.unsplash.com/photo-1506905925340-14f5ada2c2d0?auto=format&fit=crop&w=800&q=80" alt="Stockholm Old Town" />
        </div>
        <div className="day">
          <img src="https://images.unsplash.com/photo-1578662996448-3a300e7c7d8a?auto=format&fit=crop&w=800&q=80" alt="Helsinki" />
          <div className="day-content">
        ...
        <div className="day">
          ...
          <img src="https://images.unsplash.com/photo-1578662996448-3a300e7c7d8a?auto=format&fit=crop&w=800&q=80" alt="Tallinn" />
        </div>
        <div className="day">
          <img src="https://images.unsplash.com/photo-1578662996448-3a300e7c7d8a?auto=format&fit=crop&w=800&q=80" alt="Northern Lights" />
          <div className="day-content">
        ...
        <div className="day">
          ...
          <img src="https://images.unsplash.com/photo-1578662996448-3a300e7c7d8a?auto=format&fit=crop&w=800&q=80" alt="Santa Claus Village" />
        </div>
        <div className="day">
          <img src="https://images.unsplash.com/photo-1578662996448-3a300e7c7d8a?auto=format&fit=crop&w=800&q=80" alt="Departure" />
          <div className="day-content">
