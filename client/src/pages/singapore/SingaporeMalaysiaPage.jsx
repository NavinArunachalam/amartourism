    ...
    <div className="common-styles">
      ...
      <section>
        ...
        <div className="day">
          ...
          <img src=" /Singapore/Gardens by the Bay.jpg" alt="Singapore City" />
        </div>
        <div className="day">
        ...
        <div className="day">
          ...
          <img src=" /Singapore/Kuala Lumpur.jpg" alt="Kuala Lumpur" />
        </div>
        <div className="day">
          <img src=" /Singapore/Kuala Lumpur2.jpg" alt="Kuala Lumpur City Tour" />
          <div className="day-content">
        ...
        <div className="day">
          ...
          <img src=" /Singapore/Genting Highlands.jpg" alt="Genting Highlands" />
        </div>
        <div className="day">
          <img src=" /Singapore/Departure from Singapore.jpg" alt="Departure" />
          <div className="day-content">
