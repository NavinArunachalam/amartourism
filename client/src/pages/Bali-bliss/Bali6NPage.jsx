...
const Bali6NPage = () => {
  return (
      ...
      <section className="hero-bali-6n">
        <h1>Bali Bliss: Adventure</h1>
        <p>6 Nights / 7 Days - Discover the Magic of Bali</p>
      ...
      <section>
        ...
        <div className="inclusions">
          <div className="included">
            ...
            <ul>
              <li>06 Nights stay with breakfast</li>
              ...
              <li>Complimentary local lunch on Nusa Penida day</li>
              <li>One-way drop-off to Finns Beach Club</li>
            </ul>
          </div>
